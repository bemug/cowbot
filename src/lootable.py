...
lootables = (
        ...
        Lootable("Cattleman crease", Armor, PeakCurve(4,11,15),      [3],    [PeakCurve(0,0,8)]),
        Lootable("Cutter crease",    Armor, PeakCurve(4,12,15),      [2,3],  [PeakCurve(0,0,6),  PeakCurve(0,0,8)]),
        Lootable("Ridgetop crease",  Armor, PeakCurve(9,16,20),      [5],    [PeakCurve(0,0,4)]),
        Lootable("Dakota crease",    Armor, PeakCurve(9,17,20),      [3,6],  [PeakCurve(0,0,8),  PeakCurve(0,0,8)]),
        Lootable("Montana crease",   Armor, PeakCurve(15,20,22),     [6,0],  [PeakCurve(0,0,8),  PeakCurve(0,0,8)]),
        Lootable("Gus crease",       Armor, PeakCurve(15,21,23),     [4,8],  [PeakCurve(0,0,13), PeakCurve(0,0,8)]),
        Lootable("Brick crease",     Armor, PeakCurve(19,23,25),     [10,4],  [PeakCurve(0,0,13), PeakCurve(0,0,8)]),
        Lootable("Diamond crease",   Armor, PeakCurve(19,24,25),     [5,11], [PeakCurve(0,0,13), PeakCurve(0,0,13)]),
        Lootable("Telescope crease", Armor, PeakCurve(22,25,25),     [15,6], [PeakCurve(0,0,18), PeakCurve(0,0,18)]),

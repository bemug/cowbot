...
lootables = (
        ...
        Lootable("Fusil Spencer",               Weapon, PeakCurve(14,20,22),     [5,0],   [DownCurve(15), DownCurve(15)]),
        Lootable("Fusil Sharps",                Weapon, PeakCurve(14,21,22),     [3,14],  [DownCurve(15), DownCurve(15)]),
        Lootable("Fusil Springfield",           Weapon, PeakCurve(20,22,24),     [9,4],   [DownCurve(20), DownCurve(20)]),
        ...
        Lootable("Chapeau Montana",   Armor, PeakCurve(15,20,22),     [6,0],  [DownCurve(11), DownCurve(11)]),
        Lootable("Chapeau Gus",       Armor, PeakCurve(15,21,23),     [4,8],  [DownCurve(11), DownCurve(11)]),
        Lootable("Chapeau Brick",     Armor, PeakCurve(19,23,25),     [10,4], [DownCurve(13), DownCurve(13)]),
        ...
        ### Consumables
        Lootable("Tequilla", Consumable, PeakCurve(5,10,13,0.55),  [3],  [DownCurve(6)]),

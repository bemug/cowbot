...
lootables = (
        ...
        Lootable("Mitrailleuse Gatling",        Weapon, PeakCurve(10,25,25,0.1), [0,50],  [DownCurve(1),  DownCurve(30)]),
        ### Armors
        ...
        Lootable("Chapeau Gambler",   Armor, PeakCurve(12,25,25,0.1), [0,25], [DownCurve(1),  DownCurve(20)]),
